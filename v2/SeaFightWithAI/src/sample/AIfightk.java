...
public class AIfightk {
   ...
   /* public AIfightk(BadeField bd) {
    ...
    public AIfightk(GridPane paneOfEnemy, GridPane paneOfYou) {
    ...
    public static void setFieldOfEnemy(Field fieldOfEnemy) {
        AIfightk.fieldOfEnemy = fieldOfEnemy;
    }
    ...
    public static void setFieldOfYou(Field fieldOfYou) {
        AIfightk.fieldOfYou = fieldOfYou;
    }
    ...
    public static void setOnFireShip(boolean onFireShip) {
        AIfightk.onFireShip = onFireShip;
    }
    ...
    public static void setOnFireShipOr(int[] onFireShipOr) {
        AIfightk.onFireShipOr = onFireShipOr;
    }
